        ...
        >
          <v-row style="flex-grow: 1">
            <v-col cols="6" style="display: flex; flex-direction: column">
              <MapComponent
                :layerVisibility="
                  basemaps.concat(thematicLayers).reduce((obj, layer) => {
              ...
              <v-row>
                ...
                <v-col cols="4">
                  <v-card class="card-notes">
                    ...
                    <v-card-text>
                      <v-textarea v-model="notes" filled></v-textarea>
                    </v-card-text>
                  </v-card>
                </v-col>
              </v-row>
                ...
                <v-card-text>
                  ...
                  >
                    ...
                    <v-sheet>
                      ...
                      <div class="kpi">
                        {{
                          formatNumber(Math.round(aggregation.mittlFl))
                        }}&nbsp;m²
                      </div>
                    </v-sheet>
                    <v-sheet>
                    ...
                    <v-sheet>
                      ...
                      <div class="kpi">
                        {{
                          formatNumber(
                            Math.round(aggregation.tatNu_WB_P * 100) / 100
                          )
                        }}&nbsp;%
                      </div>
                    </v-sheet>
                    ...
                    <v-sheet>
                      Solarpotenzial
                      <div v-if="isNaN(aggregation.p_st_mwh_a)" class="kpi">
                        ?
                      </div>
                      <div v-else class="kpi">
                        {{
                          formatNumber(Math.round(aggregation.p_st_mwh_a))
                        }}&nbsp;MWh/a
                      </div>
                    </v-sheet>
                  </div>
                ...
                <v-card-text>
                  <v-sheet>
                    <v-btn
                      ...
                      @click="
                        areaUnit = areaUnit !== adminLevel ? adminLevel : ''
                      "
                    >
                        ...
                        [
                          {
                            text: areaUnit,
                            sortable: true,
                            value: adminLevelClassMap[areaUnit].nameProp
                          },
                          {
                            text: 'Flurstücke',
                            sortable: true,
                  ...
                  >
                    <div v-if="selectedAreas[areaUnit]">
                      <span v-if="selectedAreas[areaUnit].length > 0">
                        ...
                        {{
                          adminLevelDisplayNames[areaUnit][
                            selectedAreas[areaUnit].length == 1 ? 1 : 0
                          ]
                        }}
                        ausgewählt
                      </span>
